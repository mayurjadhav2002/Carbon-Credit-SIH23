  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Smart Contracts </h3>
              <p class="text-gray-500 dark:text-gray-400">
              Utilize smart contracts to automate the execution of carbon credit transactions.               
              </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Decentralized Marketplace</h3>
              <p class="text-gray-500 dark:text-gray-400">
              decentralized marketplace where organizations can buy and sell carbon credits directly, fostering a transparent and efficient trading ecosystem. Decentralization ensures that no single entity has control over the marketplace              </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Real-time Monitoring and Reporting</h3>
              <p class="text-gray-500 dark:text-gray-400">
              Users should have access to up-to-date information on their emissions reductions and credit availability, aiding in decision-making and compliance reporting              </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Alerts System</h3>
              <p class="text-gray-500 dark:text-gray-400">
              Develop a notification and alerts system that informs users about important events, such as the allocation of carbon credits, completed transactions, or compliance deadlines.              </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Digital Wallets</h3>
              <p class="text-gray-500 dark:text-gray-400">
              Develop digital wallets for organizations to securely store and manage their carbon credits. These wallets should provide real-time visibility into credit balances and transaction history, enhancing user control and monitoring.
                            </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white"> Authentication and Authorization</h3>
              <p class="text-gray-500 dark:text-gray-400">
              Implement robust user authentication and authorization mechanisms to ensure that only authorized users can access and perform actions within the platform. This feature enhances security and data privacy.              </p>
          </div>
      </div>
  </div>
</section>
